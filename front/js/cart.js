...
document.getElementById("order").addEventListener('click', function(event) {
    ...
    if (firstName.value.length < 3) {
        document.getElementById("firstNameErrorMsg").innerText = "Veuillez renseigner au moins 3 caractères"
    } else {
        document.getElementById("firstNameErrorMsg").innerText = ""
    }
    let lastName = document.getElementById("lastName")
    if (lastName.value.length < 3) {
        document.getElementById("lastNameErrorMsg").innerText = "Veuillez renseigner au moins 3 caractères"
    } else {
        document.getElementById("lastNameErrorMsg").innerText = ""
    }
    let address = document.getElementById("address")
    if (address.value.length < 10) {
        document.getElementById("addressErrorMsg").innerText = "Veuillez renseigner au moins 10 caractères"
    } else {
        document.getElementById("addressErrorMsg").innerText = ""
    }
    let city = document.getElementById("city")
    if (city.value.length < 3) {
        document.getElementById("cityErrorMsg").innerText = "Veuillez renseigner au moins 3 caractères"
    } else {
    ...
    if (/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(email.value)) {
        ...
        document.getElementById("emailErrorMsg").innerText = "Veuillez renseigner une adresse email"
    }
